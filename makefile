...
SRCS   := utils/utils.c network/network.c protocol/protocol.c fsops/fsops.c paths/paths.c session/session.c transfer/transfer.c locks/locks.c sh_mem/sh_mem.c
